...
BASE_VDM_PATH = os.path.join(VDM_DIR, "mpavbase.vdm")
DELTA_VDM_PATH = os.path.join(VDM_DIR, "mpavdlta.vdm")
...
SIGNATURE_TYPES = {
    ...
    0xDD: "SIGNATURE_TYPE_CMDHSTR_FAST_EXT",
...
class SignatureRecord:
    ...
    children: List["SignatureRecord"] = field(default_factory=list)
...
class ThreatBeginSignatureParser:
    MPTHREAT_CATEGORY_TABLE = {
        0: "MP_THREAT_CATEGORY_INVALID",
        1: "MP_THREAT_CATEGORY_ADWARE",
        2: "MP_THREAT_CATEGORY_SPYWARE",
        3: "MP_THREAT_CATEGORY_PASSWORDSTEALER",
        4: "MP_THREAT_CATEGORY_TROJANDOWNLOADER",
        5: "MP_THREAT_CATEGORY_WORM",
        6: "MP_THREAT_CATEGORY_BACKDOOR",
        7: "MP_THREAT_CATEGORY_REMOTEACCESSTROJAN",
        8: "MP_THREAT_CATEGORY_TROJAN",
        9: "MP_THREAT_CATEGORY_EMAILFLOODER",
        10: "MP_THREAT_CATEGORY_KEYLOGGER",
        11: "MP_THREAT_CATEGORY_DIALER",
        12: "MP_THREAT_CATEGORY_MONITORINGSOFTWARE",
        13: "MP_THREAT_CATEGORY_BROWSERMODIFIER",
        14: "MP_THREAT_CATEGORY_COOKIE",
        15: "MP_THREAT_CATEGORY_BROWSERPLUGIN",
        16: "MP_THREAT_CATEGORY_AOLEXPLOIT",
        17: "MP_THREAT_CATEGORY_NUKER",
        18: "MP_THREAT_CATEGORY_SECURITYDISABLER",
        19: "MP_THREAT_CATEGORY_JOKEPROGRAM",
        20: "MP_THREAT_CATEGORY_HOSTILEACTIVEXCONTROL",
        21: "MP_THREAT_CATEGORY_SOFTWAREBUNDLER",
        22: "MP_THREAT_CATEGORY_STEALTHNOTIFIER",
        23: "MP_THREAT_CATEGORY_SETTINGSMODIFIER",
        24: "MP_THREAT_CATEGORY_TOOLBAR",
        25: "MP_THREAT_CATEGORY_REMOTECONTROLSOFTWARE",
        26: "MP_THREAT_CATEGORY_TROJANFTP",
        27: "MP_THREAT_CATEGORY_POTENTIALUNWANTEDSOFTWARE",
        28: "MP_THREAT_CATEGORY_ICQEXPLOIT",
        29: "MP_THREAT_CATEGORY_TROJANTELNET",
        30: "MP_THREAT_CATEGORY_EXPLOIT",
        31: "MP_THREAT_CATEGORY_FILESHARINGPROGRAM",
        32: "MP_THREAT_CATEGORY_MALWARE_CREATION_TOOL",
        33: "MP_THREAT_CATEGORY_REMOTE_CONTROL_SOFTWARE",
        34: "MP_THREAT_CATEGORY_TOOL",
        36: "MP_THREAT_CATEGORY_TROJAN_DENIALOFSERVICE",
        37: "MP_THREAT_CATEGORY_TROJAN_DROPPER",
        38: "MP_THREAT_CATEGORY_TROJAN_MASSMAILER",
        39: "MP_THREAT_CATEGORY_TROJAN_MONITORINGSOFTWARE",
        40: "MP_THREAT_CATEGORY_TROJAN_PROXYSERVER",
        42: "MP_THREAT_CATEGORY_VIRUS",
        43: "MP_THREAT_CATEGORY_KNOWN",
        44: "MP_THREAT_CATEGORY_UNKNOWN",
        45: "MP_THREAT_CATEGORY_SPP",
        46: "MP_THREAT_CATEGORY_BEHAVIOR",
        47: "MP_THREAT_CATEGORY_VULNERABILTIY",
        48: "MP_THREAT_CATEGORY_POLICY",
    }

    MPTHREAT_SEVERITY_TABLE = {
        0: "MP_THREAT_SEVERITY_UNKNOWN",
        1: "MP_THREAT_SEVERITY_LOW",
        2: "MP_THREAT_SEVERITY_MODERATE",
        4: "MP_THREAT_SEVERITY_HIGH",
        5: "MP_THREAT_SEVERITY_SEVERE",
    }

    MPTHREAT_ACTION_TABLE = {
        0: "MP_THREAT_ACTION_UNKNOWN",
        1: "MP_THREAT_ACTION_CLEAN",
        2: "MP_THREAT_ACTION_QUARANTINE",
        3: "MP_THREAT_ACTION_REMOVE",
        6: "MP_THREAT_ACTION_ALLOW",
        8: "MP_THREAT_ACTION_USERDEFINED",
        9: "MP_THREAT_ACTION_NOACTION",
        10: "MP_THREAT_ACTION_BLOCK",
    }

    THREAT_SHORT_DESCRIPTION_TABLE = {
        0: '(not defined / no short-description text)',
        1: 'This program delivers potentially unwanted advertisements to your computer.',
        2: 'This program appears to be a spyware removal software, but does not disclose advertising behavior.',
        3: 'This program displays advertisements separate from the parent program.',
        4: 'This program displays pop-up advertisements.',
        5: 'This program displays advertisements based on Web browsing habits.',
        6: 'This program displays advertisements with adult content.',
        7: 'This program displays advertisements and is often bundled with other programs.',
        8: 'This program displays advertisements and may be difficult to remove.',
        9: 'This program displays advertisements based on Web search habits.',
        10: 'This program delivers advertisements and tracks activity.',
        11: 'This program displays advertisements and may be delivered through unsolicited installation.',
        12: 'This program displays advertisements and runs without a user interface.',
        13: 'This program displays advertisements inside other software.',
        14: 'This program displays deceptive product messages.',
        15: 'This program displays advertisements and may install other software.',
        16: 'This program is used to bypass security policies.',
        17: 'This program changes various Web browser settings without adequate consent.',
        18: 'This program changes the default home page.',
        19: 'This program changes the default search engine and the homepage.',
        20: 'This program changes the default search engine, the homepage, and other browser settings.',
        21: 'This program redirects access to Web pages.',
        22: 'This program changes browser settings and displays advertisements.',
        23: 'This program modifies Web page content.',
        24: 'This program changes Web page links.',
        25: 'This program adds links to adult content.',
        26: 'This program adds a browser toolbar and may be delivered through unsolicited installation.',
        27: 'This program adds a sidebar to the browser that displays advertisements.',
        28: 'This program displays adult content.',
        29: 'This program changes the default search engine.',
        30: 'This program changes browser settings and is often bundled with other programs.',
        35: 'This program dials toll numbers to create telephone charges.',
        36: 'This program dials toll numbers to gain access to adult content.',
        37: 'This program dials toll numbers and delivers advertisements for adult content.',
        38: 'This program can be used to perform a denial of service attack.',
        39: "This program overwhelms a user's inbox with email messages.",
        41: 'This program takes advantage of a security vulnerability.',
        42: 'This program allows users to download or share files.',
        46: 'This program is designed to amuse or scare the user.',
        47: 'This program monitors user activity, such as keystrokes typed.',
        49: 'This program is used to create viruses, worms or other malware.',
        50: 'This program monitors user information.',
        52: 'This program is dangerous and captures user passwords.',
        54: 'This program is often installed a bundle with other programs.',
        55: 'This program may have been installed without adequate user consent.',
        56: 'This program runs automatically and without adequate user notification.',
        58: 'This program may update without adequate user consent and may be delivered through unsolicited installation.',
        59: 'This program updates automatically without adequate user consent.',
        61: 'This program does not adequately disclose potentially unwanted behavior.',
        62: 'This program is often distributed as a component of other potentially unwanted software.',
        63: 'This program has potentially unwanted behavior.',
        64: 'This program disables other software as part of its installation.',
        66: 'This program provides remote access to the computer it is installed on.',
        69: 'This program changes various computer settings without adequate consent.',
        70: 'This program installs other potentially unwanted software.',
        72: 'This program may install other potentially unwanted software.',
        73: 'This program installs adware.',
        74: 'This program installs spyware.',
        75: 'This program installs browser modifiers.',
        76: 'This program installs software that displays adult content.',
        77: 'This program sends unauthorized e-mail.',
        78: 'This program collects user information.',
        79: 'This program tracks activity and delivers advertisements.',
        80: 'This program tracks activity and may disable other programs.',
        81: 'This program tracks activity and is often bundled with other programs.',
        82: 'This program tracks activity and may be difficult to remove.',
        83: 'This program tracks activity and all Web page content, including secure pages.',
        84: 'This program connects to the Internet in the background.',
        87: 'This program can be used for malicious purposes if unauthorized.',
        89: 'This program is dangerous and exploits the computer on which it is run.',
        90: 'This program is dangerous, exploits the computer, and provides access to user files.',
        91: 'This program is dangerous, exploits the computer, and shares user information.',
        92: 'This program is dangerous and downloads other programs.',
        93: 'This program is dangerous and installs other programs.',
        95: 'This program is dangerous and records user activity.',
        96: 'This program silently informs a server when it has been installed.',
        97: 'This program is dangerous and acts as a proxy server.',
        100: 'This program is dangerous and self-propagates over a network connection.',
        104: 'This program monitors user information, such as Web browsing habits.',
        105: 'This program changes various computer settings.',
        106: 'This program changes the system hosts file.',
        108: 'This program monitors sensitive information, such as keystrokes typed.',
        109: 'This program is dangerous and monitors user information.',
        110: 'This program is dangerous and replicates by infecting other files.',
        111: 'This program is dangerous and can hide programs or bypass security.',
        112: 'This program is dangerous and executes commands from an attacker.',
        113: 'A system change was detected. This generally occurs when software is installed.',
        114: 'This application was removed because it is blocked according to the Windows Defender Advanced Threat Protection policy.',
        115: "For your protection, this application was blocked by Microsoft Defender for Endpoint according to your organization's policy.",
        116: "This content was blocked by Microsoft Defender for Endpoint according to your organization's policy.",
    }

    THREAT_ADVICE_DESCRIPTION_TABLE = {
        0: 'Permit this detected item only if you trust the program or the software publisher.',
        1: "This software is typically benign when it runs on your computer, unless it was installed without your knowledge. If you're not sure whether to permit it, review the alert details or check if you recognize and trust the publisher of the software.",
        2: 'Review the alert details to see why the software was detected. If you do not like how the software operates or if you do not recognize and trust the publisher, consider blocking or removing the software.',
        4: 'Remove this software immediately.',
        5: 'Remove this software immediately.',
    }

    @staticmethod
    def _format_span_rule_count(entry: int) -> str:
        # Special infrastructure-style values ending in FF are not interpreted.
        if (entry & 0x00FF) == 0x00FF:
            return f"0x{entry:04X}"

        # Normal flagged span count: strip the 0x4000 flag bits.
        if (entry & 0xF000) == 0x4000:
            return str(entry & 0x3FFF)

        return str(entry)

    @staticmethod
    def _friendly_category_name(enum_name: str) -> str:
        prefix = "MP_THREAT_CATEGORY_"
        if enum_name.startswith(prefix):
            enum_name = enum_name[len(prefix):]
        ...
        labels = {
            ...
            "TOOL": "Tool",
            "TROJAN_DENIALOFSERVICE": "TrojanDenialOfService",
            "TROJAN_DROPPER": "TrojanDropper",
            "TROJAN_MASSMAILER": "TrojanMassMailer",
            "TROJAN_MONITORINGSOFTWARE": "TrojanMonitoringSoftware",
            "TROJAN_PROXYSERVER": "TrojanProxyServer",
            "VIRUS": "Virus",
            "KNOWN": "Known",
            "UNKNOWN": "Unknown",
            "SPP": "SPP",
        ...
        return labels.get(
            enum_name,
            enum_name.replace("_", " ").title().replace(" ", ""),
        )

    @staticmethod
    def _friendly_severity_name(enum_name: str) -> str:
        prefix = "MP_THREAT_SEVERITY_"
        if enum_name.startswith(prefix):
            enum_name = enum_name[len(prefix):]
        return enum_name.replace("_", " ").title()

    @staticmethod
    def _friendly_action_name(enum_name: str) -> str:
        prefix = "MP_THREAT_ACTION_"
        if enum_name.startswith(prefix):
            enum_name = enum_name[len(prefix):]
    ...
    def parse(cls, record: SignatureRecord):
        ...
        lines.append(f"    ThreatID: 0x{signature_id:08X}")
        ...
        if p + extra_info_bytes > len(data):
            ...
            if entries:
                for span_index, entry in enumerate(entries, 1):
                    lines.append(
                        f"    Span {span_index} - Rule Count: "
                        f"{cls._format_span_rule_count(entry)}"
                    )
            lines.append(
                f"    [!] Span Rule Count entries truncated: "
                f"expected {extra_info_count}, got {count}"
            )
            return lines
        entries = [int.from_bytes(data[p + i * 2:p + i * 2 + 2], "little") for i in range(extra_info_count)]
        p += extra_info_bytes
        category_name = cls.MPTHREAT_CATEGORY_TABLE.get(
            field08,
            f"UNKNOWN_0x{field08:04X}",
        )
        lines.append(
            f"    Category: {cls._friendly_category_name(category_name)}"
        )
        ...
        severity_name = cls.MPTHREAT_SEVERITY_TABLE.get(
            field_a,
            f"UNKNOWN_0x{field_a:02X}",
        )
        lines.append(
            f"    Severity: {cls._friendly_severity_name(severity_name)}"
        )

        action_value = field_b & 0x7F
        action_name = cls.MPTHREAT_ACTION_TABLE.get(
            action_value,
            f"UNKNOWN_0x{action_value:02X}",
        )
        lines.append(
            f"    Action: {cls._friendly_action_name(action_name)}"
        )
        remaining = len(data) - p
        if remaining == 0:
            return lines
        ...
        short_description = cls.THREAT_SHORT_DESCRIPTION_TABLE.get(field_c)
        lines.append(
            f"    ThreatShortDescription: "
            + (
                f'"{short_description}"'
        ...
        advice_description = cls.THREAT_ADVICE_DESCRIPTION_TABLE.get(field_d)
        lines.append(
            f"    ThreatAdviseDescription: "
            + (
                f'"{advice_description}"'
                if advice_description is not None
                else "[UNASSIGNED]"
            )
        )
...
class ThreatEndSignatureParser:
    ...
    def parse(record: SignatureRecord):
        ...
        threat_id = int.from_bytes(data[:4], "little")
        lines = [f"    ThreatID: 0x{threat_id:08X}"]
        return lines
...
class _ProjectParserUtils:
    @staticmethod
    def hex_spaced(data: bytes):
        return " ".join(f"{b:02X}" for b in data)

    @staticmethod
    def hex_compact(data: bytes):
        return "".join(f"{b:02X}" for b in data)

    @staticmethod
    def looks_like_wildcard(data: bytes):
        ...
        for i in range(len(data) - 1):
            if data[i] != 0x90:
                continue
            op = data[i + 1]
            if op == 0x00 or op == 0x90 or op < 0x32:
                return True
        return False

    @staticmethod
    def likely_utf16(data: bytes):
        if not data or len(data) < 4:
            return False
        null_odd = sum(1 for i in range(1, len(data), 2) if data[i] == 0)
        return null_odd >= len(data) // 4

    @staticmethod
    def decode_best_effort(data: bytes):
        if not data:
            return ""
        if _ProjectParserUtils.likely_utf16(data):
    ...
    @staticmethod
    def extract_utf16_ascii_strings(data: bytes, min_len=4):
        out = []
        cur = []
        i = 0
        while i + 1 < len(data):
    ...
    @staticmethod
    def render_pattern(data: bytes):
        wildcards = []
        if _ProjectParserUtils.looks_like_wildcard(data):
            try:
                rendered = PEHSTRExtSignatureParser._render_nested_payload(
                    data,
                    None,
                    True,
                    wildcards,
                ...
                if rendered:
                    return rendered, wildcards
            except Exception:
                pass
        return _ProjectParserUtils.decode_best_effort(data), wildcards


class TrustedPublisherSignatureParser:
    TYPE_NAMES = {
        1: "HASH",
        2: "BY",
        3: "TO",
    ...
    @staticmethod
    def _render_binary_value(entry_type: int, value: bytes) -> str:
        # HASH/BADHASH are binary certificate/hash values.
        if entry_type in (1, 4):
            return _ProjectParserUtils.hex_spaced(value)

        # BY/TO/TEAMID are commonly textual.  Keep binary-safe fallback.
        if entry_type in (2, 3, 5):
            try:
    ...
    @staticmethod
    def _decode_legacy_utf16(body: bytes):
        # Decode only complete UTF-16LE code units.  Search for the first
        # aligned UTF-16 NUL terminator inside the framed body.
        usable = len(body) & ~1
        end = usable
        terminated = False

        for i in range(0, usable - 1, 2):
    ...
    def parse(cls, content: bytes):
        # Layout:
        #   WORD body_size;      // little-endian
        #   BYTE body[body_size];
        #
        # body[0] < 0x20  -> binary encoding
        # body[0] >= 0x20 -> legacy NUL-terminated UTF-16LE encoding

        if len(content) < 2:
            return [
                f"    [!] TRUSTED_PUBLISHER signature too short: "
                f"{len(content)} byte(s)"
            ]

        body_size = int.from_bytes(content[:2], "little")
        body_start = 2
        available = len(content) - body_start
        actual_size = min(body_size, available)
        body = content[body_start:body_start + actual_size]

        lines = [
            f"    BodySize: 0x{body_size:04X} ({body_size})",
        ]

        if body_size > available:
            lines.append(
                f"    [!] Body truncated: expected {body_size} byte(s), "
                f"got {available}"
            )

        if not body:
            lines.append("    Encoding: Empty")
        elif body[0] < 0x20:
            entry_type = body[0]
            value = body[1:]
            type_name = cls.TYPE_NAMES.get(entry_type)

            lines.append("    Encoding: Binary")
            lines.append(
                "    EntryType: "
                + (
                    f"{type_name} (0x{entry_type:02X})"
                    if type_name is not None
                    else f"0x{entry_type:02X}"
                )
            )
            lines.append(
                f"    Value: {cls._render_binary_value(entry_type, value)}"
            )
        else:
            legacy_text, terminated = cls._decode_legacy_utf16(body)
            upper = legacy_text.upper()

            entry_type = 3
            type_name = "TO"
            value_text = legacy_text

            for prefix, candidate_type in cls.LEGACY_PREFIXES:
                if upper.startswith(prefix):
                    entry_type = candidate_type
                    type_name = cls.TYPE_NAMES[candidate_type]
                    value_text = legacy_text[len(prefix):]
                    break

            lines.append("    Encoding: UTF-16LE")
            lines.append(
                f"    EntryType: {type_name} (0x{entry_type:02X})"
            )
            lines.append(f'    Value: "{value_text}"')

            if not terminated:
                lines.append(
                    "    [!] UTF-16LE body has no NUL terminator "
                    "inside body_size"
                )

        consumed = body_start + actual_size
        if consumed < len(content):
            lines.append(
                f"    Trailing: "
                f"{_ProjectParserUtils.hex_spaced(content[consumed:])}"
            )

        return lines


class GenericBinarySignatureParser:
    def __init__(self, signature_name):
        self.signature_name = signature_name

    def parse(self, content: bytes):
        return [
            f"    Hex: {_ProjectParserUtils.hex_spaced(content)}"
        ]


class GenericTextDumpSignatureParser:
    def __init__(self, signature_name):
        self.signature_name = signature_name
    ...
    def parse(self, content: bytes):
        ...
        if _ProjectParserUtils.looks_like_wildcard(content):
            rendered, wildcards = _ProjectParserUtils.render_pattern(content)
            lines.append(f"    Text: {rendered}")
        else:
            ascii_strings = _ProjectParserUtils.extract_ascii_strings(content, 4)
            utf16_strings = _ProjectParserUtils.extract_utf16_ascii_strings(content, 4)
            combined = ascii_strings + utf16_strings
            if combined:
                for i, value in enumerate(combined):
                    lines.append(f'    Text[{i}]: "{value}"')
            else:
                lines.append("    Text:")

        lines.append(f"    Hex: {_ProjectParserUtils.hex_spaced(content)}")
        return lines, wildcards


class DefaultsSignatureParser:
    @classmethod
    def parse(cls, content: bytes):
        ascii_text = content.decode("utf-8", errors="replace").strip("\x00")
        unicode_strings = []
        ...
        while i < len(content) - 1:
            ...
            while j + 1 < len(content):
                cu = int.from_bytes(content[j:j + 2], "little")
                if cu == 0:
                    if len(chars) >= 2:
        ...
        for idx, value in enumerate(unicode_strings):
            lines.append(f'    UTF16LE[{idx}]: "{value}"')
        return lines



class NscriptBruteSignatureParser:
    @classmethod
    def parse(cls, content: bytes):
        # Layout:
        #   BYTE  labelLength;
        #   BYTE  label[labelLength];
        #   BYTE  unknown[6];
        #   DWORD size;          // little-endian
        #   BYTE  blobRule[size];

        if len(content) < 1:
            return [
                "    [!] NSCRIPT_BRUTE signature too short: 0 byte(s)"
            ]

        label_length = content[0]
        label_start = 1
        label_end = label_start + label_length

        if label_end > len(content):
            label_raw = content[label_start:]
            label = label_raw.decode("utf-8", errors="replace").rstrip("\x00")
            return [
                f"    Label: \"{label}\"",
                f"    [!] Label truncated: expected {label_length} byte(s), "
                f"got {len(label_raw)}",
            ]

        label_raw = content[label_start:label_end]
        label = label_raw.decode("utf-8", errors="replace").rstrip("\x00")

        base_start = label_end
        min_remaining = 6 + 4

        if len(content) < base_start + min_remaining:
            return [
                f"    Label: \"{label}\"",
                f"    [!] NSCRIPT_BRUTE signature too short after label: "
                f"{len(content) - base_start} byte(s)",
                f"    Raw: "
                f"{_ProjectParserUtils.hex_spaced(content[base_start:])}",
            ]

        unknown = content[base_start:base_start + 6]
        size_offset = base_start + 6
        blob_size = int.from_bytes(
            content[size_offset:size_offset + 4],
            "little",
        )
        blob_start = size_offset + 4

        available = len(content) - blob_start
        actual_size = min(blob_size, available)
        blob = content[blob_start:blob_start + actual_size]

        lines = [
            f"    Label: \"{label}\"",
            f"    Unknown: {_ProjectParserUtils.hex_spaced(unknown)}",
            f"    Size: 0x{blob_size:08X} ({blob_size})",
        ]
        wildcards = []

        if blob_size > available:
            lines.append(
                f"    [!] blobRule truncated: expected {blob_size} byte(s), "
                f"got {available}"
            )

        if not blob:
            lines.append("    blobRule:")
        elif _ProjectParserUtils.looks_like_wildcard(blob):
            rendered, wildcards = _ProjectParserUtils.render_pattern(blob)
            lines.append(f"    blobRule: {rendered}")
        else:
            rendered, is_text = PEHSTRExtSignatureParser._fmt_info(blob)
            lines.append(f"    blobRule: {rendered}")

        consumed = blob_start + actual_size
        if consumed < len(content):
            lines.append(
                f"    Trailing: "
                f"{_ProjectParserUtils.hex_spaced(content[consumed:])}"
...
class NscriptCureSignatureParser:
    @classmethod
    def parse(cls, content: bytes):
        lines = []
        strings = _ProjectParserUtils.extract_ascii_strings(content, 4)
        if strings:
            lines.append("    EmbeddedText:")
        ...
        for i in range(0, len(content), 16):
            ...
            lines.append(
                f"    Hex[{i // 16}]: {_ProjectParserUtils.hex_spaced(chunk)}"
            )
        return lines


class PepCodeSignatureParser:
    @classmethod
    def parse(cls, content: bytes):
        return [
            f"    Hex[{i // 16}]: {_ProjectParserUtils.hex_spaced(content[i:i + 16])}"
            for i in range(0, len(content), 16)
        ]


class PuaAppMapSignatureParser:
    @classmethod
    def parse(cls, content: bytes):
        strings = _ProjectParserUtils.extract_ascii_strings(content, 4)
        if not strings:
        ...
        return (
            ...
            + [f'    String[{i}]: "{s}"' for i, s in enumerate(strings)]
        )


class NdatSignatureParser:
    @staticmethod
    def _try_printable_utf8(data: bytes):
        if not data:
            return None
    ...
    def parse(cls, content: bytes):
        # Layout:
        #   BYTE sizeLow;
        #   WORD sizeHigh;      // little-endian
        #   BYTE unknown[2];
        #   BYTE data[size];
        #
        # size = sizeLow | (sizeHigh << 8)

        if len(content) < 5:
            return [
                f"    [!] NDAT signature too short: {len(content)} byte(s)"
            ]

        size_low = content[0]
        size_high = int.from_bytes(content[1:3], "little")
        data_size = size_low | (size_high << 8)

        unknown = content[3:5]

        data_start = 5
        available = len(content) - data_start
        actual_size = min(data_size, available)
        data_blob = content[data_start:data_start + actual_size]

        lines = [
            f"    Size: 0x{data_size:06X} ({data_size})",
            f"    Unknown: {_ProjectParserUtils.hex_spaced(unknown)}",
        ]

        if data_size > available:
            lines.append(
                f"    [!] Data truncated: expected {data_size} byte(s), "
                f"got {available}"
            )

        text_value = cls._try_printable_utf8(data_blob)

        if text_value is not None:
            lines.append(f'    Data: "{text_value}"')
        else:
            lines.append(
                f"    Data: {_ProjectParserUtils.hex_spaced(data_blob)}"
            )

        consumed = data_start + actual_size
        if consumed < len(content):
            lines.append(
                f"    Trailing: "
                f"{_ProjectParserUtils.hex_spaced(content[consumed:])}"
...
class Polyvir32SignatureParser:
    ENTRY_SIZE = 16

    @classmethod
    def parse(cls, content: bytes):
        lines = []
        if len(content) < 16 or len(content) % 16:
            lines.append(
                f"    [!] Unusual structure size: {len(content)} byte(s)"
            )

        count = 0
        for pos in range(0, len(content) - 15, 16):
            lines.append(
                f"    Entry[{count}]: "
                f"{_ProjectParserUtils.hex_spaced(content[pos:pos + 16])}"
            )
            count += 1

        lines.insert(0, f"    Entries: {count}")
        return lines


class GenericFixedHashListSignatureParser:
    ...
    def __init__(
        ...
        self.auto_strides = auto_strides
        self.max_tail_padding = max_tail_padding
        self.min_entries = min_entries

    @staticmethod
    def _looks_plausible(hashes, hash_size):
        if not hashes:
            return False
        ...
        if all(h == zero for h in hashes):
            return False
        if all(h == ffff for h in hashes):
            return False
        if len(unique) <= 1:
            return False

        need_unique = min(3, len(hashes))
        return len(unique) >= need_unique

    def _try_layout(self, content, header_size, stride):
        if stride <= 0:
            return None
        if self.hash_offset < 0 or self.hash_offset + self.hash_size > stride:
            return None
        if header_size not in (0, 2, 4) or len(content) < header_size:
            return None

        offset = header_size
        data_len = len(content) - offset

        if header_size == 2:
            count = int.from_bytes(content[:2], "little")
            if count <= 0 or count > self.MAX_RECORDS:
                return None
            used = count * stride
            pad = data_len - used
            if pad < 0 or pad > self.max_tail_padding:
                return None
            ...
            if data_len < stride:
                return None
            usable = (data_len // stride) * stride
            pad = data_len - usable
            if pad > self.max_tail_padding:
                return None
            count = usable // stride
        ...
        for _ in range(count):
            if pos + stride > len(content):
                return None
            h = content[
                pos + self.hash_offset:
                pos + self.hash_offset + self.hash_size
            ]
            hashes.append(_ProjectParserUtils.hex_compact(h))
            pos += stride

        if not self._looks_plausible(hashes, self.hash_size):
            return None
    ...
    def parse(self, content: bytes):
        ...
        strides = (
            ...
            else list(self.auto_strides or [])
        )

        for header in headers:
            for stride in strides:
                result = self._try_layout(content, header, stride)
                if result is None:
                    continue

                lines = [
                    f"    Layout: header={result['header']} "
                    f"stride={result['stride']} count={result['count']} "
                    f"tailPad={result['pad']}"
                ]
        ...
        return [
            "    Layout: BLOB",
            f"    Raw: {_ProjectParserUtils.hex_spaced(content)}",
        ]


class PestaticSignatureParser:
    BASE_STRUCT_SIZE = 16

    @classmethod
    def parse(cls, content: bytes):
        # Reversed RuleData layout:
        #
        #   DWORD crc_first_0x40;
        #   DWORD crc_first_0x200;
        #   DWORD crc_range;
        #   DWORD range_end_offset;
        #
        # Optional label metadata follows the 16-byte base exactly like KCRCE:
        #
        #   BYTE metadata_length;
        #   BYTE metadata_name[metadata_length];

        if len(content) < cls.BASE_STRUCT_SIZE:
            return [
                f"    [!] PESTATIC RuleData too short: "
                f"{len(content)} byte(s)"
            ]
        ...
        (
            ...
            crc_range,
            range_end_offset,
        ) = struct.unpack_from("<IIII", content, 0)

        lines = [
            f"    CRC32(first 0x40 bytes): 0x{crc_first_0x40:08X}",
            f"    CRC32(first 0x200 bytes): 0x{crc_first_0x200:08X}",
            f"    CRC32(range): 0x{crc_range:08X}",
            f"    RangeEndOffset: 0x{range_end_offset:08X}",
        ]

        # Exactly 16 bytes means there is no appended label.
        if len(content) == cls.BASE_STRUCT_SIZE:
            return lines

        metadata_length = content[cls.BASE_STRUCT_SIZE]
        metadata_start = cls.BASE_STRUCT_SIZE + 1
        metadata_end = metadata_start + metadata_length

        lines.append(
            f"    threat_metadata_length: "
            f"0x{metadata_length:02X} ({metadata_length})"
        )

        if metadata_end > len(content):
            metadata_raw = content[metadata_start:]
            metadata_name, _ = ThreatBeginSignatureParser._unpack_virus_name(
                metadata_raw
            )
            lines.append(f'    threat_metadata: "{metadata_name}"')
            lines.append(
                f"    [!] threat_metadata truncated: "
                f"expected {metadata_length} byte(s), "
                f"got {len(metadata_raw)}"
            )
            return lines

        metadata_raw = content[metadata_start:metadata_end]
        metadata_name, _ = ThreatBeginSignatureParser._unpack_virus_name(
            metadata_raw
        )
        lines.append(f'    threat_metadata: "{metadata_name}"')
        ...
        if metadata_end < len(content):
            trailing = content[metadata_end:]
            lines.append(
                f"    trailing_bytes: "
                f"{' '.join(f'{b:02X}' for b in trailing)}"
            )

        return lines


class KcrceexSignatureParser:
    CANDIDATE_STRIDES = (12, 16, 20, 24, 28, 32)
    TRY_HEADER_SIZES = (4, 2, 0)
    ACCEPTED_TAIL_PADS = (0, 2, 4, 6, 8)
    MAX_RECORDS = 1_000_000

    @classmethod
    def _extract_items(cls, content, start, stride, count):
        items = []
        pos = start
        for _ in range(count):
            if pos + stride > len(content):
                return None
            crc = int.from_bytes(content[pos:pos + 4], "little")
            index = (
                int.from_bytes(content[pos + 4:pos + 8], "little")
                if stride >= 8
                else 0
            )
            weight = (
                int.from_bytes(content[pos + 8:pos + 10], "little")
                if stride >= 10
                else None
            )
            flags = (
                int.from_bytes(content[pos + 10:pos + 12], "little")
                if stride >= 12
                else None
            )
            extra = (
                content[pos + 12:pos + stride]
                if stride > 12
                else b""
            )
            items.append(
    ...
    @classmethod
    def _try_layout(cls, content, header, stride):
        if header not in (0, 2, 4):
            return None
        if len(content) < header + stride:
            return None
        ...
        if header == 2:
            count = int.from_bytes(content[:2], "little")
            if count <= 0 or count > cls.MAX_RECORDS:
                return None
            pad = next(
                (
                    p for p in cls.ACCEPTED_TAIL_PADS
                    if grid_start + count * stride + p == len(content)
                ),
                None,
            )
            if pad is None:
            ...
            if length % stride == 0:
                ...
                count = None
                pad = None
                for candidate_pad in cls.ACCEPTED_TAIL_PADS:
                    data_len = length - candidate_pad
                    if data_len > 0 and data_len % stride == 0:
        ...
        items = cls._extract_items(content, grid_start, stride, count)
        if not items:
            return None
    ...
    @staticmethod
    def _looks_plausible(items):
        if not items:
            return False

        crcs = [x["crc"] for x in items]
        if all(x == 0 for x in crcs):
            return False
        if all(x == 0xFFFFFFFF for x in crcs):
            return False
        ...
        if n <= 4:
            if n == 1:
                if crcs[0] in (0, 0xFFFFFFFF):
                    return False
            elif unique < 2:
                return False
        elif unique < max(3, n // 4):
            return False

        with_index = sum(1 for x in items if x["index"] != 0)
        if with_index >= n // 2:
            ok = 0
            checks = 0
            have_last = False
            ...
            for item in items:
                idx = item["index"]
                if idx == 0 and not have_last:
                    last = idx
                    have_last = True
                    continue

                if have_last:
                    delta = (last - idx) & 0xFFFFFFFF
                    if idx >= last or delta <= 4:
                        ok += 1
                    checks += 1
            ...
            if checks > 4 and ok < (checks * 2 // 3):
                return False

        n_bytes = 1
        target = unique * 2
        while n_bytes < target and n_bytes < (1 << 20):
            n_bytes <<= 1
        n_bits = n_bytes * 8
        if n_bits <= 0:
            return False

        seeds = (1996959901, -301047503, -1727442449, 124634143)
        for crc in crcs:
            ok = 0
            for seed in seeds:
                h = (seed * crc) & 0xFFFFFFFF
                bit = h % n_bits
                if 0 <= bit < n_bits:
                    ok += 1
            if ok < 3:
    ...
    @classmethod
    def parse(cls, content: bytes):
        for header in cls.TRY_HEADER_SIZES:
            for stride in cls.CANDIDATE_STRIDES:
                result = cls._try_layout(content, header, stride)
                if result is None or not cls._looks_plausible(result["items"]):
                    continue

                lines = [
                    f"    Layout: header={header} stride={stride} "
                    f"count={result['count']} tailPad={result['pad']}"
                ]
                for i, item in enumerate(result["items"]):
                    line = (
                        f"    Entry[{i}]: CRC=0x{item['crc']:08X} "
                        f"Index=0x{item['index']:08X}"
                    )
                    if item["weight"] is not None:
                        line += f" Weight={item['weight']}"
                    if item["flags"] is not None:
                        line += f" Flags=0x{item['flags']:04X}"
                    if item["extra"]:
                        line += (
                            f" Extra={_ProjectParserUtils.hex_spaced(item['extra'])}"
                        )
                    lines.append(line)
                return lines
...
class PEBMPATSignatureParser:
    ...
    def parse(cls, content: bytes):
        ...
        #   BYTE data[data_size];
        #
        # data[] may contain HSTR_EXT wildcards.

        if len(content) < 4:
            return [
                f"    [!] PEBMPAT signature too short: "
                f"{len(content)} byte(s)"
            ]

        label_size = int.from_bytes(content[0:2], "big")
        data_size = int.from_bytes(content[2:4], "little")
        ...
        if label_end > len(content):
            ...
            label = label_raw.decode("utf-8", errors="replace").rstrip("\x00")
            return [
                f"    LabelSize: {label_size}",
                f'    Label: "{label}"',
                f"    [!] Label truncated: expected {label_size} byte(s), "
                f"got {len(label_raw)}",
            ]
        ...
        if not data_blob:
            lines.append("    Data:")
        elif _ProjectParserUtils.looks_like_wildcard(data_blob):
            rendered, wildcards = _ProjectParserUtils.render_pattern(data_blob)
            lines.append(f"    Data: {rendered}")
        else:
            rendered, _is_text = PEHSTRExtSignatureParser._fmt_info(data_blob)
            lines.append(f"    Data: {rendered}")
...
class PestaticExSignatureParser:
    @classmethod
    def parse(cls, content: bytes):
        if len(content) < 5:
            return [
                f"    [!] PESTATICEX signature too small: {len(content)} byte(s)"
            ]

        threshold = int.from_bytes(content[0:2], "little")
        subrule_count = int.from_bytes(content[2:4], "little")
        control = content[4]
        p = 5

        lines = [
            f"    Threshold: {threshold}",
            f"    SubRuleCount: {subrule_count}",
        ...
        for i in range(subrule_count):
            if p + 3 > len(content):
                lines.append(
                    f"    [!] SubRule[{i}] header truncated"
                )
                break

            weight = int.from_bytes(content[p:p + 2], "little")
            length = content[p + 2]
            p += 3

            if p + length > len(content):
                lines.append(
                    f"    [!] SubRule[{i}] truncated: need {length} byte(s)"
                )
                break

            payload = content[p:p + length]
            p += length

            rendered, sub_wildcards = _ProjectParserUtils.render_pattern(payload)
            wildcards.extend(sub_wildcards)

            lines.extend(
                [
                    f"    SubRule[{i}].Weight: {weight}",
                    f"    SubRule[{i}].Length: {length}",
                    f"    SubRule[{i}].Pattern: {rendered}",
                ]
            )

        if p < len(content):
            lines.append(
                f"    Trailing: {_ProjectParserUtils.hex_spaced(content[p:])}"
            )
    ...
    def get_weight_stats(cls, content: bytes):
        if len(content) < 5:
            return None
        threshold = int.from_bytes(content[0:2], "little")
        count = int.from_bytes(content[2:4], "little")
        p = 5
        weights = []
        parsed = 0
        for _ in range(count):
...
class GenericWeightedPatternSignatureParser:
    def __init__(self, signature_name):
        self.signature_name = signature_name
    ...
    def _read(content):
        ...
        threshold = int.from_bytes(content[2:4], "little")
        ...
        for i in range(count):
            ...
            ascii_tag = False
            if p + 2 <= len(content) and content[p:p + 2] == b"\x80\x01":
                ascii_tag = True
                p += 2

            if p + rule_len > len(content):
                break

            payload = content[p:p + rule_len]
            p += rule_len
    ...
    def parse(self, content: bytes):
        parsed = self._read(content)
        if parsed is None:
            return [
                f"    [!] {self.signature_name} size too small: "
                f"{len(content)} byte(s)"
            ]

        lines = [
            f"    Unknown: 0x{parsed['unknown']:04X}",
            f"    Threshold: {parsed['threshold']}",
            f"    SubRuleCount: {parsed['count']}",
            f"    Control: 0x{parsed['control']:02X}",
        ]
        wildcards = []
        ...
        for sub in parsed["subs"]:
            if (
                not sub["ascii_tag"]
                and _ProjectParserUtils.looks_like_wildcard(sub["payload"])
            ):
                rendered, sub_wildcards = _ProjectParserUtils.render_pattern(
                    sub["payload"]
                )
                wildcards.extend(sub_wildcards)
            else:
                rendered = _ProjectParserUtils.decode_best_effort(
                    sub["payload"]
                )

            lines.extend(
                [
                    f"    SubRule[{sub['index']}].Weight: {sub['weight']}",
                    f"    SubRule[{sub['index']}].Type: "
                    + (
                        f"0x{sub['type']:02X}"
                        if sub["type"] <= 0x02
                        else "0xFF"
                    ),
                    f"    SubRule[{sub['index']}].Length: {sub['length']}",
                    f"    SubRule[{sub['index']}].AsciiTag: "
                    f"{1 if sub['ascii_tag'] else 0}",
                    f"    SubRule[{sub['index']}].Pattern: {rendered}",
                ]
            )

        if len(parsed["subs"]) != parsed["count"]:
            lines.append(
                f"    [!] ParsedSubRules: {len(parsed['subs'])}/"
                f"{parsed['count']}"
            )
        ...
        if parsed["end"] < len(content):
            lines.append(
                f"    Trailing: "
                f"{_ProjectParserUtils.hex_spaced(content[parsed['end']:])}"
            )

        return lines, wildcards

    def get_weight_stats(self, content: bytes):
        parsed = self._read(content)
        if parsed is None:
            return None
        return (
            parsed["threshold"],
            [x["weight"] for x in parsed["subs"]],
            len(parsed["subs"]),
        )


class SigTreeSignatureParser:
    ATTR_NAMES = {
        0x0501: "ATTR_0501",
        0x0001: "ATTR_0001",
        0x002B: "ATTR_002B",
    ...
    CONTAINER_ATTRS = {0x0001, 0x1A04, 0x100E}

    @classmethod
    def _attr_label(cls, attr):
        name = cls.ATTR_NAMES.get(attr)
        return (
            f"{name}(0x{attr:04X})"
            if name
            else f"ATTR_0x{attr:04X}"
        )

    @staticmethod
    def _likely_ascii(data):
        if not data:
            return False
        bad = 0
        max_bad = max(1, len(data) // 10)
        for b in data:
    ...
    def _inner_pairs(payload):
        ...
        while i + 2 < len(payload):
            if payload[i + 1] == 0x60:
                ...
                len_pos = i + 2
                data_pos = len_pos + 1
                length = payload[len_pos]

                if length == 0x00 and len_pos + 1 < len(payload):
                    length = payload[len_pos + 1]
                    data_pos = len_pos + 2
                elif length == 0xFF and len_pos + 2 < len(payload):
                    length = int.from_bytes(
                        payload[len_pos + 1:len_pos + 3],
                        "little",
                    )
                    data_pos = len_pos + 3

                remaining = len(payload) - data_pos
                if 0 <= length <= remaining:
                    result.append(
                        {
                            "key": key,
                            "offset": i,
                            "value": payload[data_pos:data_pos + length],
                        }
                    )
                    i = data_pos + length
                    continue
    ...
    def parse(cls, content: bytes):
        if len(content) < 5:
            return [
                f"    [!] SIGTREE size too small: {len(content)} byte(s)"
            ]
        ...
        while p + 5 <= len(content):
            atom_start = p
            flags = int.from_bytes(content[p:p + 2], "little")
            attr = int.from_bytes(content[p + 2:p + 4], "little")
            length = content[p + 4]
            p += 5
            remaining = len(content) - p

            if length > remaining:
                lines.append(
                    f"    Atom#{atom_idx}: Flags=0x{flags:04X} "
                    f"Attr={cls._attr_label(attr)} Len={length} "
                    f"Kind=TRUNCATED Missing={length - remaining}"
                )
                break
            ...
            kind = (
                "empty"
                if length == 0
                else ("ascii" if cls._likely_ascii(payload) else "binary")
            )

            summary = (
                f"    Atom#{atom_idx}: Flags=0x{flags:04X} "
                f"Attr={cls._attr_label(attr)} Len={length} Kind={kind}"
            )

            if length > 0 and attr in cls.CONTAINER_ATTRS:
                items = cls._inner_pairs(payload)
                if items:
                    counts = {}
                    inner_parts = []
                    for item in items:
                        ...
                        inner_parts.append(
                            f"K_{item['key']:02X}@+0x{item['offset']:X}"
                            f"/len={len(item['value'])}"
                        )
                    stats = [
                        f"K_{key:02X}={count}"
            ...
            if payload:
                lines.append(
                    f"      Payload: {_ProjectParserUtils.hex_spaced(payload)}"
                )
        ...
        if p < len(content):
            lines.append(
                f"    Tail: {_ProjectParserUtils.hex_spaced(content[p:])}"
            )

        return lines


class SigTreeExtSignatureParser:
    LOGIC = {
        0x01: "AND",
        0x02: "LEAF",
        0x03: "OR",
    ...
    @staticmethod
    def _find_marker(data, start):
        for i in range(max(0, start), len(data) - 1):
            if data[i] == 0x30 and data[i + 1] == 0x00:
                return i
        return -1
    ...
    def parse(cls, content: bytes):
        if len(content) < 4:
            return [
                f"    [!] SIGTREE_EXT size too small: {len(content)} byte(s)"
            ]

        node_count = int.from_bytes(content[0:2], "little")
        flags = int.from_bytes(content[2:4], "little")
        lines = [
        ...
        p = 4
        parsed_nodes = 0
        first_marker = cls._find_marker(content, p)

        if first_marker > p:
            prolog = content[p:first_marker]
            lines.append(
                f"    Prolog: {_ProjectParserUtils.hex_spaced(prolog)}"
            )
            if any(prolog) and parsed_nodes < node_count:
                lines.append(
                    f"    Node#{parsed_nodes}: PROLOG len={len(prolog)}"
                )
                parsed_nodes += 1
            p = first_marker

        while parsed_nodes < node_count and p + 2 <= len(content):
            if content[p:p + 2] != b"\x30\x00":
                nxt = cls._find_marker(content, p + 1)
                if nxt < 0:
                    break
                p = nxt
            ...
            if p + 9 > len(content):
                lines.append(
                    f"    [!] Node#{parsed_nodes} header truncated "
                    f"@+0x{node_start:X}"
                )
                break
            ...
            n_type = content[p]
            n_flags = content[p + 1]
            child1 = int.from_bytes(content[p + 2:p + 4], "little")
            child2 = int.from_bytes(content[p + 4:p + 6], "little")
            weight = int.from_bytes(content[p + 6:p + 8], "little")
            u8 = content[p + 8]
            p += 9

            payload_start = p
            if parsed_nodes == node_count - 1:
                payload_end = len(content)
            else:
                nxt = cls._find_marker(content, p)
                payload_end = nxt if nxt >= 0 else len(content)

            payload = content[payload_start:payload_end]
            logic = cls.LOGIC.get(n_type, f"TYPE_0x{n_type:02X}")

            lines.append(
                f"    Node#{parsed_nodes}: Type=0x{n_type:02X}({logic}) "
                f"Flags=0x{n_flags:02X} Child1={child1} Child2={child2} "
                f"Weight={weight} U8=0x{u8:02X} PayloadLen={len(payload)}"
            )
            if payload:
                lines.append(
                    f"      Payload: {_ProjectParserUtils.hex_spaced(payload)}"
        ...
        lines.append(f"    ParsedNodes: {parsed_nodes}/{node_count}")
        return lines


class SigTreeBmSignatureParser:
    @staticmethod
    def _read_header(content):
        ...
        return {
            "node_count": int.from_bytes(content[:2], "little"),
            "flags": int.from_bytes(content[2:4], "little"),
            "header": "H1(u16,u16)",
            "unknown_u8": None,
            "pos": 4,
    ...
    @staticmethod
    def _read_len(content, pos, total):
        if pos >= total:
            return None
        ...
        pos += 1
        if first != 0:
            return first, pos, "u8", 0

        save = pos

        if pos < total:
            length = content[pos]
            if pos + 1 + length <= total:
                return length, pos + 1, "00+u8", 0

        pos = save
        if pos + 2 <= total:
            length = int.from_bytes(content[pos:pos + 2], "little")
            if length > 0 and pos + 2 + length <= total:
                return length, pos + 2, "00+u16", 0

        pos = save
        if pos + 4 <= total:
            length = int.from_bytes(content[pos:pos + 4], "little")
            if length > 0 and pos + 4 + length <= total:
                return length, pos + 4, "00+u32", 0

        pos = save
        if pos + 5 <= total:
            tag = int.from_bytes(content[pos:pos + 4], "little")
            length = content[pos + 4]
            if pos + 5 + length <= total:
                return length, pos + 5, "00+tag32+u8", tag

        return None

    @classmethod
    def _scan_inner_atoms(cls, payload):
        if len(payload) < 12:
            return []
        ...
        while i + 5 <= limit and len(out) < 16:
            start = i
            flags = int.from_bytes(payload[i:i + 2], "little")
            attr = int.from_bytes(payload[i + 2:i + 4], "little")
            p = i + 4

            length_info = cls._read_len(payload, p, limit)
            if length_info is None:
                i = start + 1
                continue

            length, data_pos, flavor, _ = length_info
            if data_pos + length > limit:
                i = start + 1
                continue
            ...
            out.append(
                {
                    ...
                    "length": length,
                    "flavor": flavor,
                    "data": payload[data_pos:data_pos + length],
                }
            )
            i = data_pos + length
    ...
    @classmethod
    def parse(cls, content: bytes):
        header = cls._read_header(content)
        if header is None:
            return [
                f"    [!] SIGTREE_BM size too small: {len(content)} byte(s)"
            ]

        lines = [
            f"    Header: {header['header']}",
            f"    NodeCount: {header['node_count']}",
            f"    Flags: 0x{header['flags']:04X}",
        ]
        if header["unknown_u8"] is not None:
            lines.append(
                f"    HeaderUnknownU8: 0x{header['unknown_u8']:02X}"
            )
        ...
        while atom_idx < header["node_count"] and p + 5 <= len(content):
            atom_start = p
            flags = int.from_bytes(content[p:p + 2], "little")
            attr = int.from_bytes(content[p + 2:p + 4], "little")
            p += 4

            length_info = cls._read_len(content, p, len(content))
            if length_info is None:
                length = len(content) - p
                data_pos = p
                flavor = "LAST_REST"
                tag = 0
            else:
                length, data_pos, flavor, tag = length_info

            remaining = len(content) - data_pos
            if length > remaining:
                lines.append(
                    f"    Atom#{atom_idx}: Flags=0x{flags:04X} "
                    f"Attr=0x{attr:04X} Len={length}({flavor}) "
                    f"Kind=TRUNCATED Missing={length - remaining}"
                )
                truncated = True
                break

            payload = content[data_pos:data_pos + length]
            line = (
                f"    Atom#{atom_idx}: Flags=0x{flags:04X} "
                f"Attr=0x{attr:04X} Len={length}({flavor})"
            )
            if flavor == "00+tag32+u8":
                line += f" Tag=0x{tag:08X}"
            lines.append(line)
            ...
            if payload:
                ...
                inner = cls._scan_inner_atoms(payload)
                for j, item in enumerate(inner):
                    lines.append(
                        f"      Inner[{j}]: Flags=0x{item['flags']:04X} "
                        f"Attr=0x{item['attr']:04X} "
                        f"Len={item['length']}({item['flavor']}) "
                        f"@+0x{item['offset']:X}"
                    )
        ...
        wide = _ProjectParserUtils.extract_utf16_ascii_strings(content, 6)
        for i, value in enumerate(wide):
            lines.append(f'    UTF16LE[{i}]: "{value}"')

        lines.append(
            f"    ParsedAtoms: {atom_idx}/{header['node_count']} "
            f"Truncated={1 if truncated else 0}"
        )
        return lines


class KCRCESignatureParser:
    BASE_STRUCT_SIZE = 16
    ...
    def parse(cls, content: bytes):
        if len(content) < cls.BASE_STRUCT_SIZE:
            return [
                f"    [!] KCRCE RuleData too short: {len(content)} byte(s)"
            ]

        fast_crc, crc1, crc2, param = struct.unpack_from(
            "<IIII",
            content,
            0,
        )

        crc2_length = param & 0xFFFF
        crc2_offset = (param >> 16) & 0x0FFF
        unknown_bit28 = (param >> 28) & 0x1
        unknown_bit29 = (param >> 29) & 0x1
        require_fastcrc = (param >> 30) & 0x1
        strict_crc2 = (param >> 31) & 0x1
        crc2_masked = param & 0x0FFFFFFF

        lines = [
            f"    fast_crc: 0x{fast_crc:08X}",
            f"    crc1: 0x{crc1:08X}",
            f"    crc2: 0x{crc2:08X}",
            f"    param_raw: 0x{param:08X}",
            f"    param_crc2_masked: 0x{crc2_masked:08X}",
            f"    param.crc2_length: 0x{crc2_length:04X} ({crc2_length})",
            f"    param.crc2_offset: 0x{crc2_offset:03X} ({crc2_offset})",
            f"    param.unknown_bit28: {unknown_bit28}",
            f"    param.unknown_bit29: {unknown_bit29}",
            f"    param.require_fastcrc: {require_fastcrc}",
            f"    param.strict_crc2: {strict_crc2}",
        ]

        # Exactly 16 bytes: base KCRCE only, no metadata.
        if len(content) == cls.BASE_STRUCT_SIZE:
            return lines

        # Metadata is embedded directly after the 16-byte base struct:
        #   BYTE metadata_length;
        #   BYTE metadata_name[metadata_length];
        metadata_length = content[cls.BASE_STRUCT_SIZE]
        metadata_start = cls.BASE_STRUCT_SIZE + 1
        ...
        # Use exactly the same name unpacking logic as THREAT_BEGIN, including
        # packed/prefixed names and literal prefixes such as ! / !#...
        metadata_name, _ = ThreatBeginSignatureParser._unpack_virus_name(
            metadata_raw
        )
        lines.append(f'    threat_metadata: "{metadata_name}"')
...
class PEHSTRExtSignatureParser:
    ...
    def _format_90_05(cls, xx, pattern):
        # 90 05 XX YY <pattern>
        #
        # A pattern may contain a leading regex/range set followed by literal
        # bytes.  The range portion consumes XX bytes, while the literal suffix
        ...
        #   -> [a-fA-F0-9]{9}.
        #
        # If the whole pattern consists only of ranges, retain the previously
        # reversed "up to XX" behavior.
        range_end = 0
        while (
            range_end + 2 < len(pattern)
            and pattern[range_end + 1] == 0x2D
        ):
            range_end += 3

        if range_end and range_end < len(pattern):
            range_pattern = pattern[:range_end]
            literal_suffix = pattern[range_end:]

            regex_class = cls._format_regex_class(
                range_pattern,
                case_insensitive=False,
            )
            counted = regex_class if xx == 1 else f"{regex_class}{{{xx}}}"
            return counted + cls._fmt_wildcard_bytes(literal_suffix)

        # Existing pure-range behavior.
        regex_class = cls._format_regex_class(
            pattern,
            case_insensitive=(0x2D in pattern),
        )
    ...
    def _read_wildcard_token(cls, data, i):
        ...
        if op in (0x01, 0x02):
            ...
            # 90 04 retains the strict range-only encoding currently known.
            # 90 05 additionally permits literal bytes after the range set.
            if op == 0x04 and 0x2D in pattern:
                if (
                    yy % 3 != 0
                    or not all(
                        pattern[j + 1] == 0x2D
                        for j in range(0, yy, 3)
                    )
                ):
                    return None
...
class ThreatDatabase:
    ...
    def __init__(self, db_path="Threats.db"):
        ...
        self.conn.executescript("""
            ...
            CREATE TABLE signatures (
                ...
                FOREIGN KEY(parent_signature_id) REFERENCES signatures(id) ON DELETE CASCADE
            );
            ...
            CREATE INDEX idx_signatures_parent_id ON signatures(parent_signature_id);
    ...
    def save_threat(self, threat: ThreatRecord):
        ...
        cur.execute(
            ...
            (
                threat.threat_id,
                f"0x{threat.start_offset:X}",
                f"0x{end_offset:X}" if end_offset is not None else None,
                int(threat.complete),
        ...
        def insert_signature(sig, signature_index, parent_signature_id=None, depth=0):
            cur.execute(
                """
                ...
                (
                    ...
                    sig.size_high,
                    sig.size,
                    sqlite3.Binary(sig.content),
                    "\n".join(sig.parsed_lines),
                    sig.contains_wildcard,
                ),
            )
            signature_db_id = cur.lastrowid

            for child_index, child in enumerate(sig.children, 1):
                insert_signature(
                    child,
                    child_index,
                    parent_signature_id=signature_db_id,
                    depth=depth + 1,
                )

        for signature_index, sig in enumerate(threat.signatures, 1):
            insert_signature(sig, signature_index)
...
class DefenderSignatureStreamParser:
    def __init__(self, db_path="Threats.db", weight_log_path=WEIGHT_ANOMALY_LOG, weight_anomaly_ratio=WEIGHT_ANOMALY_RATIO):
        ...
        self.handlers = {
            ...
            0x80: KCRCESignatureParser,
            0xBD: LuaStandaloneSignatureParser,
        }

        # All Defender HSTR_EXT signature families share the custom extended
        # parser already reverse-engineered in this project.
        for _sig_type, _sig_name in SIGNATURE_TYPES.items():
            if "HSTR_EXT" in _sig_name:
                self.handlers[_sig_type] = PEHSTRExtSignatureParser

        # Additional HSTR variants confirmed from Defender's dispatcher.
        # These share the same HSTR_EXT framing/parser.
        for _sig_type in (0x92, 0xDD, 0xEF):
            self.handlers[_sig_type] = PEHSTRExtSignatureParser

        # DefenderRuleParser-compatible dump-driven/heuristic handlers.
        # These intentionally preserve that project's current assumptions so
        # their semantics can be refined later as each format is reversed.
        self.handlers.update({
            0x20: GenericFixedHashListSignatureParser(
                "SIGNATURE_TYPE_KVIR32",
                entry_size=0,
                hash_offset=0,
                hash_size=4,
                auto_strides=[16, 20, 22, 24, 28, 32],
                max_tail_padding=8,
                min_entries=2,
            ),
            0x21: Polyvir32SignatureParser,
            0x29: NscriptBruteSignatureParser,
            0x2C: NscriptCureSignatureParser,
            0x40: SigTreeSignatureParser,
            0x41: SigTreeExtSignatureParser,
            0x58: DefaultsSignatureParser,
            0x62: GenericFixedHashListSignatureParser(
            ...
            0x67: GenericBinarySignatureParser(
                "SIGNATURE_TYPE_STATIC"
            ),
            0x70: TrustedPublisherSignatureParser,
            0x87: PestaticSignatureParser,
            0x8A: PepCodeSignatureParser,
            0x95: PEBMPATSignatureParser,
            0xA9: NdatSignatureParser,
            0xB3: SigTreeBmSignatureParser,
            0xCB: PestaticExSignatureParser,
            0xCC: KcrceexSignatureParser,
            0xE8: PuaAppMapSignatureParser,
        })

        # Generic weighted-pattern families routed this way by DefenderRuleParser.
        for _weighted_type in (0x89, 0x96, 0xBB, 0xBC):
            self.handlers[_weighted_type] = GenericWeightedPatternSignatureParser(
                SIGNATURE_TYPES[_weighted_type]
            )

        # Generic binary families from DefenderRuleParser's dispatcher.
        for _binary_type in (
            0x55, 0xCE, 0x8B, 0x7F, 0x83, 0xAB, 0xD8, 0xD6,
            0xAC, 0xE7, 0x7E, 0x28, 0x27, 0x50, 0x11, 0x44,
            0x42, 0xCF, 0x90, 0x88, 0x9D, 0x7A, 0xBA, 0xB4,
            0xC8, 0xC9, 0x51, 0x77,
        ):
            if _binary_type in SIGNATURE_TYPES:
                self.handlers[_binary_type] = GenericBinarySignatureParser(
                    SIGNATURE_TYPES[_binary_type]
                )

        # Generic text families from DefenderRuleParser's dispatcher that are
        # present in this script's type map.
        for _text_type in (
            0x49, 0xDC, 0xAD, 0x6A, 0x98, 0x4A, 0x43,
            0x64, 0x6C, 0xD0, 0xA8,
        ):
            if _text_type in SIGNATURE_TYPES:
                self.handlers[_text_type] = GenericTextDumpSignatureParser(
                    SIGNATURE_TYPES[_text_type]
                )

        self.record_handlers = {
            THREAT_BEGIN: ThreatBeginSignatureParser,
            THREAT_END: ThreatEndSignatureParser,
            FILEPATH: FolderNameSignatureParser,
            FOLDERNAME: FolderNameSignatureParser,
            REGKEY: RegKeySignatureParser,
            ASEP_FILEPATH: FolderNameSignatureParser,
            ASEP_FOLDERNAME: FolderNameSignatureParser,
            FRIENDLYFILE_SHA256: FriendlyFileHashSignatureParser,
            FRIENDLYFILE_SHA512: FriendlyFileHashSignatureParser,
        }
    @staticmethod
    def _decode_dbvar_name(raw: bytes):
        return "".join(
    ...
    @staticmethod
    def _validate_embedded_signature_sequence(data: bytes, start: int):
        """Return record descriptors if data[start:] is fully parseable."""
        ...
        while pos < len(data):
            ...
            size_low = data[pos + 1]
            size_high = int.from_bytes(data[pos + 2:pos + 4], "little")
            ...
            records.append((pos, sig_type, size_low, size_high, size, end))
            pos = end

        return records if records else None

    def _parse_dbvar(self, record: SignatureRecord):
        content = record.content

        if not content:
            record.parsed_lines = [
                "    [!] DBVAR RuleData is empty"
            ]
            return

        var_length = content[0]
        var_start = 1
        var_end = var_start + var_length

        if var_end > len(content):
            var_raw = content[var_start:]
            record.parsed_lines = [
                f"    varLength: 0x{var_length:02X} ({var_length})",
                f'    varName: "{self._decode_dbvar_name(var_raw)}"',
                "    [!] varName exceeds DBVAR RuleData boundary",
            ]
            return

        var_raw = content[var_start:var_end]
        var_name = self._decode_dbvar_name(var_raw)

        # Unknown bytes have no declared length. Find the earliest offset after
        # varName from which all remaining bytes form valid signature records.
        child_start = None
        child_descriptors = None

        for candidate in range(var_end, len(content)):
            descriptors = self._validate_embedded_signature_sequence(
                content,
                candidate,
            )
            if descriptors is not None:
                child_start = candidate
                child_descriptors = descriptors
                break

        if child_start is None:
            unknown = content[var_end:]
            record.parsed_lines = [
                f"    varLength: 0x{var_length:02X} ({var_length})",
                f'    varName: "{var_name}"',
                (
                    f"    unknown: "
                    f"{' '.join(f'{b:02X}' for b in unknown)}"
                    if unknown
                    else "    unknown:"
                ),
                "    childRules: 0",
        ...
        unknown = content[var_end:child_start]
        record.parsed_lines = [
            f"    varLength: 0x{var_length:02X} ({var_length})",
            f'    varName: "{var_name}"',
            (
            ...
            f"    childRules: {len(child_descriptors)}",
        ]

        record.children = []

        for child_pos, sig_type, size_low, size_high, size, child_end in child_descriptors:
            child_content = content[child_pos + 4:child_end]

            # record.offset is the absolute offset of the parent's 4-byte
            # signature header. Its RuleData therefore begins at +4.
            child_absolute_offset = record.offset + 4 + child_pos
            ...
            # Parse child exactly like a normal signature. Nested DBVAR works
            # recursively through _parse_signature_content().
            self._parse_signature_content(child)
    ...
    def _parse_signature_content(self, record: SignatureRecord):
        ...
        try:
            if record.sig_type == DBVAR:
                self._parse_dbvar(record)
            elif record_handler:
    ...
    def parse(self, data: bytes):
        ...
        while index < len(data):
            ...
            if sig_type == THREAT_BEGIN:
                ...
                if (
                    sig_type == THREAT_END
                    and self.current_threat.signatures
                ):
                    begin_record = self.current_threat.signatures[0]

                    if (
                        begin_record.sig_type == THREAT_BEGIN
                        and len(begin_record.content) >= 4
                        and len(record.content) >= 4
                    ):
                        begin_signature_id = int.from_bytes(
                            begin_record.content[:4],
                            "little",
                        )
                        end_signature_id = int.from_bytes(
                            record.content[:4],
                            "little",
                        )

                        if begin_signature_id != end_signature_id:
                            record.parsed_lines.append(
                                f"    [!] ThreatID mismatch: "
                                f"THREAT_BEGIN=0x{begin_signature_id:08X}, "
                                f"THREAT_END=0x{end_signature_id:08X}"
                            )
